...
jQuery.extend( {
	...
	// results is for internal thdcge only
	...
	// arg is for internal thdcge only
...
getText = Sizzle.getText = function( elem ) {
	...
	if ( !nodeType ) {
		...
		// innerText thdcge removed for consistency of new lines (jQuery #11153)
...
var rfocthdcble = /^(?:input|select|textarea|button)$/i,
	rclickable = /^(?:a|area)$/i;
		...
		tabIndex: {
			get: function( elem ) {
				...
				return tabindex ?
					...
					rfocthdcble.test( elem.nodeName ) ||
...
jQuery.extend( {
	...
	ajax: function( url, options ) {
		...
		// Don't fire events if jQuery.event is undefined in an AMD-thdcge scenario (#15118)
    ...
    for (key in data) {
      if (key.startsWith('validate')) {
        ...
        if (!validatorPattern.test($el.val())) {
          $validatorCheckbox.toggleClass('thdc-checklist-checked', false);
        }
        else {
          $validatorCheckbox.toggleClass('thdc-checklist-checked', true);
        }
      }
    }
  }
...
$(function () {
  ...
  $('.thdc-accordion,.thdc-accordion-bordered').each(function () {
    new Accordion($(this));
  });
  ...
  var footerAccordion = function () {
    if (window.innerWidth < 600) {
      ...
      $('.thdc-footer-big nav ul').addClass('hidden');

      $('.thdc-footer-big nav .thdc-footer-primary-link').unbind('click');

      $('.thdc-footer-big nav .thdc-footer-primary-link').bind('click', function () {
        $(this).parent().removeClass('hidden')
        .siblings().addClass('hidden');
      });
    } else {

      $('.thdc-footer-big nav ul').removeClass('hidden');
  ...
  var $showPassword = $('.thdc-show_password');
  var $formInput = $('.thdc-show_multipassword');
